...
import DogCarousel from "../ui/DogCarousel";
import DogSkeleton from "../skeletons/DogSkeleton";
        ...
        <div className="flex justify-center mt-20">
          ...
          <div className="w-[600px] flex justify-end">
            <div className="w-[500px] flex flex-col justify-between my-10">
              ...
              <p>
                The dog is a mammal with sharp teeth, an excellent sense of
                smell, and a fine sense of hearing. Each of its four legs ends
                in a foot, or paw, with five toes. Each toe has a soft pad and a
                claw. A coat of hair keeps the dog warm. It cools off by panting
                and hanging its tongue out of its mouth.
              </p>
